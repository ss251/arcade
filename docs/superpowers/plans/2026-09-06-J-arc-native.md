...
RPC/signing ports.7B4 still owns the explicit escrow wire/request/settlement
context and active rail; Task7 remains in progress. Existing exact-only payloads
and tree-only settle arguments must not be populated with dummy escrow values.
