...
5. Identity: the seller's Arc 8004 id and settled feedback appear in the catalogue via the Arc subgraph; ENS subname resolves to the same payTo; revoke the role → next call refuses.
