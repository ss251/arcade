...
export function IndexedEvidence({ evidence }: { readonly evidence: unknown }) {
  ...
  return <section className="skill-evidence" aria-label="Indexed evidence">
    <h2>Graph index</h2>
    ...
    <dl className="skill-facts">
      ...
      <div><dt>Indexed settlements</dt><dd className="skill-code">{graph.settlementCount}</dd></div>
      <div><dt>Indexed feedback</dt><dd className="skill-code">{graph.feedbackCount}</dd></div>
      <div><dt>Indexed validations passed</dt><dd className="skill-code">{graph.validationPassCount}</dd></div>
    </dl>
