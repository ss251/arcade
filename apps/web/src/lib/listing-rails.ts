...
/** Optional malformed metadata must not erase an otherwise valid catalogue row. */
...
export function filterCatalogue<T>(listings: readonly T[], selection: RailFilter): readonly T[] {
